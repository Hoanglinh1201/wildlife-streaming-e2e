...
from simulator.server.background.lifecycle_animal_update import lifecycle_animal_update
from simulator.server.background.move_update import move_animal_task
